...
import br.com.fatecpg.classes.Question;
    ...
    try {
      ...
      out.write("            ");
                ...
                for(int i = 0; i < Quiz.getQuestions().size(); i++)
                {
                    ...
                    sOut += "<label>" + q.getQuestion() +"</label>";
                    
                    for(int j = 0; j < q.getAlternatives().length; j++)
                        sOut += "<input type='radio' name='" + i + "' value='" + q.getAlternatives()[j].toString() +"' required>" + q.getAlternatives()[j].toString();
